...
import type { PostgresProviderSearchRepository } from "../../../infrastructure/persistence/repository/postgres-provider-search-repository.js";
...
export type ProviderSearchRoutesDeps = {
  providerSearch: PostgresProviderSearchRepository;
  geo: IGeoService;
};
